...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: site.description,
    siteName: site.name,
    // No explicit images here — Next.js auto-attaches the dynamic OG card
    // generated by app/opengraph-image.tsx via its file-based convention.
    // Hard-coding `site.ogImage` (which points at /og.png, a file we don't
    // ship) would shadow it and break social previews.
  },
  twitter: {
    ...
    // images omitted — inherits from openGraph above.
  },
  robots: {
    index: true,
    follow: true,
